...
public class Signup3 extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        String a = null;
        if(r1.isSelected()) a = "Saving Account";
        else if(r2.isSelected()) a = "Fixed Deposit Account";
        else if(r3.isSelected()) a = "Current Account";
        else if(r4.isSelected()) a = "Recurring Deposit Account";
        ...
        String b = "";
        if(c1.isSelected()) b = b + " ATM Card";
        if(c2.isSelected()) b = b + " Internet Banking";
        if(c3.isSelected()) b = b + " Mobile Banking";
        if(c4.isSelected()) b = b + " EMAIL Alerts";
        if(c5.isSelected()) b = b + " Cheque Book";
        if(c6.isSelected()) b = b + " E-Statement";
        
        String c = t1.getText();
        
        try {
            if(ae.getSource() == b1) {
                if(b.equals("")) JOptionPane.showMessageDialog(null, "Fill all the required fields");
                else {
            ...
            } else if(ae.getSource() == b2) System.exit(0);
        } catch(Exception ex) {
            ex.printStackTrace();
        }
    }
