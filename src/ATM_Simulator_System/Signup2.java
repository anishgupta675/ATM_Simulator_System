...
public class Signup2 extends JFrame implements ActionListener {
    ...
    Signup2() {
        ...
        int x = fm.stringWidth("NEW APPLICATION FORM - PAGE 2");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        String h = "";
        if(r1.isSelected()) h = "Yes";
        else if(r2.isSelected()) h = "No";
        
        String i = "";
        if(r3.isSelected()) i = "Yes";
        else if(r4.isSelected()) i = "No";
        
        String j = t3.getText();
        
        try {
            
            if(t2.getText().equals("")) JOptionPane.showMessageDialog(null, "Fill all the required fields");
            else {
                conn c1 = new conn();
